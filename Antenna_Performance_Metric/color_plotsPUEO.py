...
# run with python3 FScorePlot.py /path/to/runName /path/to/runName (NPOP) (gens)
...
print("finished saving fitness scores")
Veff_plot.savefig(g.destination + "/" + "Veffectives_RG.png")
print("finished saving Veffs")
