...
RunName='2023_07_24_test5'	## This is the name of the run. You need to make a unique name each time you run.
...
CROSSOVER=84 #84			## Number (not fraction!) of individuals formed through crossover
MUTATION=14 #16 #1		## Number (not fraction!) of individuals formed through crossover	
SIGMA=5 #5				## Standard deviation for the mutation operation (divided by 100)
ROULETTE=20 #20			## Number (not fraction!) of individuals formed through crossover
TOURNAMENT=20 #20		## Number (not fraction!) of individuals formed through crossover
RANK=60 #60				## Number (not fraction!) of individuals formed through crossover
