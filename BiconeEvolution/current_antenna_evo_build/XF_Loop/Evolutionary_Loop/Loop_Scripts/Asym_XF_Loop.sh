...
RunName='2023_07_24_test4'	## This is the name of the run. You need to make a unique name each time you run.
...
CROSSOVER=6 #84			## Number (not fraction!) of individuals formed through crossover
...
RANK=6 #60				## Number (not fraction!) of individuals formed through crossover
